...
namespace MultiChannelBot.Models
{
    ...
    {
        public ImageActionsDataRegions[] Regions { get; set; }
    }

    public class ImageActionsDataRegions
    {
        public BoundingRectangle BoundingBox { get; set; }

        public ImageActionsDataRegionsText[] Lines { get; set; }

        public ImageActionsDataRegionsText[] Words { get; set; }
    }

    public class ImageActionsDataRegionsText
    {
