...
namespace RennovationsBot
{
    ...
    ///  - See <see cref="RennovationsIBot"/> constructor for how that is injected.
    ///  - See the Startup.cs file for more details on creating the Singleton that gets
    ///    injected into the constructor.
    /// </summary>
    public class RennovationsBotAccessors
    {
        /// <summary>
        ...
        public RennovationsBotAccessors(ConversationState conversationState, UserState userState)
        {
        ...
        /// </value>
        public IStatePropertyAccessor<FridgeDisposalState> GetRidOfTheFridgeState { get; set; }
